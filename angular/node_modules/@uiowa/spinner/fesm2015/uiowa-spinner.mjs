...
LoadingPlaceholderComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: LoadingPlaceholderComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
LoadingPlaceholderComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.11", type: LoadingPlaceholderComponent, selector: "loading-placeholder", ngImport: i0, template: `<div class="placeholder-item"></div>`, isInline: true, styles: [".placeholder-item{box-shadow:0 4px 10px #21212126;position:relative;overflow:hidden;height:100%}.placeholder-item:before{content:\"\";display:block;position:absolute;left:-200px;top:0;height:100%;width:200px;background:linear-gradient(to right,transparent 0%,#e8e8e8 50%,transparent 100%);animation:load 1s cubic-bezier(.4,0,.2,1) infinite}@keyframes load{0%{left:-200px}to{left:100%}}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: LoadingPlaceholderComponent, decorators: [{
            type: Component,
            args: [{ selector: 'loading-placeholder', template: `<div class="placeholder-item"></div>`, changeDetection: ChangeDetectionStrategy.OnPush, styles: [".placeholder-item{box-shadow:0 4px 10px #21212126;position:relative;overflow:hidden;height:100%}.placeholder-item:before{content:\"\";display:block;position:absolute;left:-200px;top:0;height:100%;width:200px;background:linear-gradient(to right,transparent 0%,#e8e8e8 50%,transparent 100%);animation:load 1s cubic-bezier(.4,0,.2,1) infinite}@keyframes load{0%{left:-200px}to{left:100%}}\n"] }]
...
export { ActionSpinnerComponent, LoadingBarComponent, LoadingPlaceholderComponent, SpinnerModule, UiowaRingComponent };
